...
- (CALayer*) buildImage:(CGSize)viewBounds image:(UIImage*)image position:(CGPoint)position
{
    if (!image)
    {
        return nil;
...
//    UIImage *image = [UIImage imageNamed:imageFile];
    ...
    layerImage.frame = CGRectMake(position.x, position.y, viewBounds.width, viewBounds.height);
